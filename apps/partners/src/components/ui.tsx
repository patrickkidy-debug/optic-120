...
export function PageHeader({
  ...
  return (
    <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
      <div>
        <h1 className="font-display text-2xl font-bold text-content-heading">{title}</h1>
...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 p-4 backdrop-blur-sm sm:items-center">
      <div className={clsx('card w-full animate-fade-in p-0 shadow-card-lg', sizes[size])} role="dialog" aria-modal="true">
