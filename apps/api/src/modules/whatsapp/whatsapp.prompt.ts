/**
 * Prompt système du chatbot commercial WhatsApp d'OculoSaaS.
 * La grille tarifaire reflète PLAN_CATALOG (packages/shared-types) — la tenir
 * synchronisée en cas de changement de prix.
 */
...
- Pose tes questions de qualification UNE PAR UNE. Ne pose jamais plusieurs questions dans le même message. Attends la réponse avant d'enchaîner sur la suivante.
